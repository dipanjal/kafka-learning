...
Type=simple
User=ubuntu
ExecStart=/home/ubuntu/kafka_2.12-3.1.0/bin/zookeeper-server-start.sh /home/ubuntu/kafka_2.12-3.1.0/config/zookeeper.properties
ExecStop=/home/ubuntu/kafka_2.12-3.1.0/bin/zookeeper-server-stop.sh
Restart=on-abnormal
